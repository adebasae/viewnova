...
!(function e(t, n, i) {
...
})(
  {
          ...
          return {
            beforeInit: function (e) {
              ...
              e.ensureScalesHaveIDs(),
                t.scales &&
                  ((i.supported = !0),
                  o.each(t.scales.xAxes, n),
                  o.each(t.scales.yAxes, n));
            },
            ...
            afterInit: function (e) {
              ...
              if (o.isArray(t) && t.length > 0) {
                ...
                r.collapseHoverEvents(t).forEach(function (t) {
                  o.addEvent(n, t, i),
                    e.annotation.onDestroy.push(function () {
                      o.removeEvent(n, t, i);
                    });
                });
              }
        ...
        t.exports = function (t) {
          ...
          function i(e) {
            ...
            if (
              ('mousemove' === e.type &&
                (l && !l.hovering
                  ? ['mouseenter', 'mouseover'].forEach(function (t) {
                      ...
                      (l.hovering = !0),
                        'function' == typeof d[n] && u.push([d[n], i, l]);
                    })
                  : l ||
              ...
              l &&
                s.indexOf('dblclick') > -1 &&
                'function' == typeof d.onDblclick)
            ) {
              if ('click' === e.type && 'function' == typeof d.onClick)
                return (
              ...
              'dblclick' === e.type &&
                l.clickTimeout &&
                (clearTimeout(l.clickTimeout), delete l.clickTimeout);
            }
            l &&
              'function' == typeof d[f] &&
              0 === u.length &&
          ...
          var o = t.helpers,
            a = e('./helpers.js')(t);
          return { dispatcher: i, collapseHoverEvents: n };
        };
      },
      { './helpers.js': 5 },
    ],
    5: [
      function (e, t, n) {
        ...
        t.exports = function (e) {
          function t(t) {
            return (
              (t = h.configMerge(e.Annotation.defaults, t)),
              h.isArray(t.annotations) &&
          ...
          function f(e) {
            ...
            'undefined' == typeof e.options.ticks.min &&
              'undefined' == typeof e.options.ticks.suggestedMin &&
              (e.min = t.min),
              'undefined' == typeof e.options.ticks.max &&
                'undefined' == typeof e.options.ticks.suggestedMax &&
                (e.max = t.max),
    ...
    6: [
      function (e, t, n) {
        var i = e('chart.js');
        (i = 'function' == typeof i ? i : window.Chart),
            ...
            i = t.Annotation.Element.extend({
              setDataLimits: function () {
                ...
                if (((e.ranges = {}), r)) {
                  ...
                  o &&
                    ((l = n.isValid(t.xMin)
                      ? t.xMin
                      : o.getPixelForValue(r.left)),
                    (s = n.isValid(t.xMax)
                      ? t.xMax
                      : o.getPixelForValue(r.right)),
                    (e.ranges[t.xScaleID] = {
                      min: Math.min(l, s),
                      max: Math.max(l, s),
                    })),
                    a &&
                      ((l = n.isValid(t.yMin)
                        ? t.yMin
                        : a.getPixelForValue(r.bottom)),
                      (s = n.isValid(t.yMax)
                        ? t.yMax
                        : a.getPixelForValue(r.top)),
                      (e.ranges[t.yScaleID] = {
                        min: Math.min(l, s),
                        max: Math.max(l, s),
                      }));
              ...
              configure: function () {
                var e = this._model,
                  ...
                  a = i.scales[t.yScaleID],
                  r = i.chartArea;
                e.clip = { x1: r.left, x2: r.right, y1: r.top, y2: r.bottom };
                var l,
                  s,
                  c = r.left,
                  u = r.top,
                ...
                o &&
                  ((l = n.isValid(t.xMin)
                    ? o.getPixelForValue(t.xMin)
                    : r.left),
                  (s = n.isValid(t.xMax)
                    ? o.getPixelForValue(t.xMax)
                    : r.right),
                  (c = Math.min(l, s)),
                  (f = Math.max(l, s))),
                  a &&
          ...
          function i(e, t, n, i, o) {
            ...
            switch (!0) {
              case e.mode == l && 'top' == e.labelPosition:
                (u = o + e.labelYAdjust),
                  (c = t / 2 + e.labelXAdjust),
                  (s.y = e.y1 + u),
                  (s.x = (isFinite(a.m) ? a.getX(s.y) : e.x1) - c);
                break;
              case e.mode == l && 'bottom' == e.labelPosition:
                (u = n + o + e.labelYAdjust),
                  (c = t / 2 + e.labelXAdjust),
                  (s.y = e.y2 - u),
                  (s.x = (isFinite(a.m) ? a.getX(s.y) : e.x1) - c);
                break;
              case e.mode == r && 'left' == e.labelPosition:
                (c = i + e.labelXAdjust),
                  (u = -(n / 2) + e.labelYAdjust),
                  (s.x = e.x1 + c),
                  (s.y = a.getY(s.x) + u);
                break;
              case e.mode == r && 'right' == e.labelPosition:
                (c = t + i + e.labelXAdjust),
                  (u = -(n / 2) + e.labelYAdjust),
                  (s.x = e.x2 - c),
                  (s.y = a.getY(s.x) + u);
                break;
              default:
                (s.x = (e.x1 + e.x2 - t) / 2 + e.labelXAdjust),
                  (s.y = (e.y1 + e.y2 - n) / 2 + e.labelYAdjust);
            }
            return s;
          }
          var o = t.helpers,
            ...
            s = t.Annotation.Element.extend({
              ...
              configure: function () {
                ...
                if (
                  (f &&
                    ((e = a.isValid(s.value)
                      ? f.getPixelForValue(s.value)
                      : NaN),
                    (t = a.isValid(s.endValue)
                      ? f.getPixelForValue(s.endValue)
                      : e)),
                  !isNaN(e))
                ) {
                  var d = c.chartArea;
                  (l.clip = {
                    ...
                    (l.line = new n(l)),
                    (l.mode = s.mode),
                    (l.labelBackgroundColor = s.label.backgroundColor),
                    (l.labelFontFamily = s.label.fontFamily),
                    (l.labelFontSize = s.label.fontSize),
                    (l.labelFontStyle = s.label.fontStyle),
                    (l.labelFontColor = s.label.fontColor),
                    (l.labelXPadding = s.label.xPadding),
                    (l.labelYPadding = s.label.yPadding),
                    (l.labelCornerRadius = s.label.cornerRadius),
                    (l.labelPosition = s.label.position),
                    (l.labelXAdjust = s.label.xAdjust),
                    (l.labelYAdjust = s.label.yAdjust),
                    (l.labelEnabled = s.label.enabled),
                    (l.labelContent = s.label.content),
                    (u.font = o.fontString(
                      l.labelFontSize,
                      l.labelFontStyle,
                      l.labelFontFamily,
                  ...
                  (l.labelX = p.x - l.labelXPadding),
                    (l.labelY = p.y - l.labelYPadding),
                    (l.labelWidth = h + 2 * l.labelXPadding),
                    (l.labelHeight = b + 2 * l.labelYPadding),
                    (l.borderColor = s.borderColor),
                    (l.borderWidth = s.borderWidth),
                    (l.borderDash = s.borderDash || []),
                    (l.borderDashOffset = s.borderDashOffset || 0);
                }
              },
              inRange: function (e, t) {
                var n = this._model;
